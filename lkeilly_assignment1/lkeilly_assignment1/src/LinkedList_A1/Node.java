...
public class Node {
	// this is your Node object, these are the Objects in your list
	public double data;
	public Node next; // links this node to the next Node in the List
	public Node prev; // links this node to the preceeding Node in the List (ie this Node is the prev
						// Node's next node)
	...
	/*
	 * Below are "getters" for our testing purposes. Please do not modify. I would
	 * advise just referencing the fields of your Nodes since they are public
	 */
